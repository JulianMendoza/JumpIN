...
public class MoveSetTest extends TestCase {
	...
	private Board board;
	private Fox fox, fox2, fox3, fox4;
	private List<MoveSet> moves;
	private GameView view;
	private Rabbit rabbit;

	/**
	 * System.out.println(moves.size()); for(MoveSet ms:moves) { for(Move m:ms) {
	 * System.out.println("Old
	 * Pos:"+m.getOldPos().getX()+","+m.getOldPos().getY()+"New
	 * Pos:"+m.getNewPos().getX()+","+m.getNewPos().getY()); } } DEBUGGING LOGIC
	 **/
	@Override
